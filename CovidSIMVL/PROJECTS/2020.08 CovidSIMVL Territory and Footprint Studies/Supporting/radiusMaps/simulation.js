...
try {
   ...
   var ri, rj;
    ...
    function drawC(x, y, rad, color) {
        ...
        if (xTopLeft<0){
          rWidth = rWidth - Math.absolute(xTopLeft);
          xTopLeft=0;
        };
        if (x+rad>799){
        ...
        if (yTopLeft<0){
          rHeight = rHeight - Math.absolute(yTopLeft);
          yTopLeft=0;
        }
        if (y+rad>599){
...
//  DRAW GRID
        ...
        footPrint = (3.14159/4)*arenaCt;
        arenaPerCent = (footPrint/480000 * 100).toFixed(2);
...
//       console.log("gen="+gen+" mF="+mF+" x,y="+x.toFixed(2)+","+y.toFixed(2)+" HzR="+rad.toFixed(2)+" arena%="+arenaPerCent+" sectorTL-BR="+xSectTL+","+ySectTL+" "+xSectBR+","+ySectBR+" sectorCt+% "+sectorCt+","+sectorPerCent);
       console.log("HzR "+rad.toFixed(2)+" gen "+gen+" x "+x.toFixed(2)+" y "+y.toFixed(2)+" footp "+footPrint.toFixed(0)+" sects "+sectorCt);

       drawRect(0, 0, 270, 80, "black");
       ctx.font = "30px Arial";
       ctx.fillStyle = "white";
