...
console.log("CovidSIMVL 2021.01.07 custom for Pfizer built-in temporal model - NOT FOR GENERAL USE"
console.log("Pfizer.js - use with PfizerIndex.html");
...
try {
    ...
    */
    ...
    M.UCt = 9;
    console.log(Date());
    console.log("CovidSIMVL Mode1 and Mod2 Pfizer");
    console.log("Mode 1 >13 and <22 is 54%");
    console.log("Mode 2 >22 is 95%; >13 and <22 is 54%");
    if (use_html) {
