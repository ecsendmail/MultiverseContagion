...
try {
    ...
    */
    ...
    var tViral = [0.5, 2, 3.95, 7.75, 15.22, 20, 20, 17.58, 13.55, 11.66, 10.18, 9.90, 7.98, 6.80, 5.96, 5.20, 2.21, 1.86, 1.54, 1.32, 1, 1];
...
//        }
    ...
    function upDateGraph(Q, q) {
      ...
      if (M.YellowCt==0 && M.BlueCt==0 && M.RedCt==0) {alert('STOP')};
    }
