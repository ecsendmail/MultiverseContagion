...
// ****************************************************************************
console.log("CovidSIMVL Feb 14, 2021 Vaccination Implementation variants - no Age Cohorts, just choose mode - no longer current");
console.log("simulationRev2Vax.js - use with indexRev2Vax.html");
...
try {
    ...
    */
    ...
    M.UCt = 9;
    console.log(Date());
    console.log("CovidSIMVL Mode1 and Mod2 vaccinations use P");
    if (use_html) {
