...
try {
    ...
    */
    ...
    M.UCt = 9;
    console.log(Date());
    console.log("CovidSIMVL Mode1, Mode2 and Mode 3 vaccinations");
    if (use_html) {
...
//        }
    ...
    function VLtransfer(i, j) {
      ...
      if (P[Vsmall].ViralLoad!=0) { }
          ...
          if (U[wU].vaxMode == 2 || U[wU].vaxMode == 3){
            if (vaxT>28) {
