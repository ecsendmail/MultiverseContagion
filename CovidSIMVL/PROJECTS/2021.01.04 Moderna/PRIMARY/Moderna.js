...
console.log("CovidSIMVL Feb 14, 2021 Vaccination Implementation variants - no longer current");
console.log("Moderna.js - use with ModernaIndex.html");
...
try {
    ...
    */
    ...
    M.UCt = 9;
    console.log(Date());
    console.log("CovidSIMVL Mode1 and Mod2 Moderna");
    console.log("Mode 1 >13 and <30 is 80%");
    console.log("Mode 2 >28 is 95%; >13 and <30 is 80%");
    if (use_html) {
