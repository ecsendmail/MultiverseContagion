      ...
      if (jpostInfect > VLincD && P[i].state == "green") {
        ...
        if (Vbig == i) {
          ...
          if (P[j].tInfect == 0) {
               ...
               console.log(iInf+"I j:famKey "+j+":"+P[j].famKey+" infected by "+P[i].state+" i:famKey "+i+":"+P[i].famKey+" at gen "+gen+" in Univ"+wU+" prob="+VaxProb.toFixed(3));
			    }
            ...
            if (P[i].tInfect == 0) { // once for infection
			    ...
			    if (P[i].state=="green"){
				      let jInf = M.PCt-M.GreenCt;
				          console.log(jInf+"I i:famKey "+i+":"+P[i].famKey+" infected by "+P[j].state+" j:famKey "+j+":"+P[j].famKey+" at gen "+gen+" in U"+wU+" prob="+VaxProb.toFixed(3));
			    }
        }
    }
    // &&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
...
*/
    ...
    function reSizeAll() {
        ...
        for (i = 0; i < M.PCt; i++) {
            ...
            let adjSize = Q.baseSize;
            if (U[wU].inflate !=0){
              adjSize = adjSize * U[wU].inflate;
            }
            if (newSize < adjSize) {
                newSize = adjSize;
            } else {
...
//                document.getElementById("totouch").innerHTML = Q.allTouch;
      ...
      if (M.YellowCt==0 && M.BlueCt==0 && M.RedCt==0 && gen>1) {alert('STOP');
        return};
    }
